...
export function EventsNav({ query, onQueryChange, className }: EventsNavProps) {
  ...
  return (
    <nav
      className={cn(
        "sticky top-0 z-50 flex items-center gap-4 border-b border-border/20 bg-bg-deep/95 backdrop-blur-md px-4 py-2.5",
        className,
      )}
    >
      {/* Logo */}
      <div className="flex items-center gap-2 shrink-0">
        <span className="text-lg font-bold text-accent font-[family-name:var(--font-dongle)]">
          poqpoq
        </span>
